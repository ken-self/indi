...
*******************************************************************************/
bool LX200StarGo::SetCurrentPark()
{
    LOG_DEBUG(__FUNCTION__);
    // Command  - :X352#
    // Response - 0#
...
**
*******************************************************************************/
bool LX200StarGo::setParkPosition()
{
    LOG_DEBUG(__FUNCTION__);
    // Command  - :X352#
    // Response - 0#
...
**
*******************************************************************************/
bool LX200StarGo::getUTCOffset(double *offset)
{
    LOG_DEBUG(__FUNCTION__);
    if (isSimulation())
    {
...
**
*******************************************************************************/
bool LX200StarGo::sendScopeTime()
{
...
*******************************************************************************/
bool LX200StarGo::getSideOfPier()
{
    LOG_DEBUG(__FUNCTION__);
